...
// ══ TAGIHAN PASCABAYAR ══
// Hanya metadata brand — TIDAK ada harga karena harga realtime dari Digiflazz API
//
// Skema validasi input per produk:
//   inputMinLength / inputMaxLength  — batas panjang karakter
//   validationPattern                — regex string (tanpa /…/ literal) untuk validasi final
//   inputHint                        — teks hint default (saat kosong)
//   inputHintTyping                  — teks hint saat user masih mengetik
//   inputHintInvalid                 — teks hint saat format salah
// ─────────────────────────────────────────────────────────────────────────────
export const tagihanProducts = [
  {
    name: 'plnpasca',
    title: 'Listrik PLN Pasca',
    subtitle: 'Bayar tagihan listrik PLN pascabayar',
    icon: '<polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon>',
    inputLabel: 'Nomor Pelanggan PLN',
    inputType: 'text',
    inputMode: 'numeric',
    inputPrefix: null,
    ...
    inputMinLength: 10,
    inputMaxLength: 12,
    // Hanya angka, 10–12 digit
    validationPattern: '^\\d{10,12}$',
    inputHint: 'Nomor pelanggan PLN terdiri dari 10–12 digit angka',
    inputHintTyping: 'Lanjutkan — nomor PLN minimal 10 digit',
    inputHintInvalid: 'Nomor PLN tidak valid — hanya angka, 10–12 digit',
    skuCode: 'pln',
    accent: '#00A0E3',
  },
  {
    name: 'pdam',
    title: 'PDAM',
    subtitle: 'Bayar tagihan air PDAM',
    ...
    inputMinLength: 6,
    inputMaxLength: 20,
    // Angka atau alfanumerik (beberapa PDAM pakai kode area + angka)
    validationPattern: '^[A-Za-z0-9]{6,20}$',
    inputHint: 'Lihat nomor pelanggan pada tagihan atau kartu PDAM Anda',
    inputHintTyping: 'Lanjutkan — minimal 6 karakter',
    inputHintInvalid: 'Nomor PDAM tidak valid — 6–20 karakter angka/huruf, tanpa spasi',
    skuCode: null,
    accent: '#2B6CB0',
  },
  {
    ...
    inputLabel: 'Nomor VA / Kartu BPJS',
    inputType: 'text',
    inputMode: 'numeric',
    inputPrefix: null,
    inputPlaceholder: 'Contoh: 00012345678',
    inputMinLength: 11,
    inputMaxLength: 13,
    // Hanya angka, 11–13 digit (VA BPJS diawali 0)
    validationPattern: '^\\d{11,13}$',
    inputHint: 'Nomor VA BPJS terdiri dari 11–13 digit angka',
    inputHintTyping: 'Lanjutkan — nomor VA BPJS minimal 11 digit',
    inputHintInvalid: 'Nomor BPJS tidak valid — hanya angka, 11–13 digit',
    skuCode: 'bpjs',
    accent: '#00A651',
  },
  {
    name: 'isp',
    title: 'Internet/ISP',
    subtitle: 'Bayar tagihan internet rumah',
    icon: '<path d="M5 12.55a11 11 0 0 1 14.08 0"></path><path d="M1.42 9a16 16 0 0 1 21.16 0"></path><path d="M8.53 16.11a6 6 0 0 1 6.95 0"></path><line x1="12" y1="20" x2="12.01" y2="20"></line>',
    inputLabel: 'Nomor Pelanggan ISP',
    inputType: 'text',
    inputMode: null,
    inputPrefix: null,
    inputPlaceholder: 'Contoh: ISP-123456',
    inputMinLength: 4,
    inputMaxLength: 20,
    // Alfanumerik + tanda hubung/titik yang umum pada nomor ISP
    validationPattern: '^[A-Za-z0-9\\-\\.]{4,20}$',
    inputHint: 'Lihat nomor pelanggan pada tagihan atau modem Anda',
    inputHintTyping: 'Lanjutkan — minimal 4 karakter',
    inputHintInvalid: 'Nomor ISP tidak valid — 4–20 karakter (huruf, angka, - atau .)',
    skuCode: null,
    accent: '#553C9A',
  },
  {
    ...
    inputMinLength: 4,
    inputMaxLength: 20,
    // Alfanumerik + tanda hubung, kompatibel dengan berbagai provider (Indovision, First Media, dll)
    validationPattern: '^[A-Za-z0-9\\-]{4,20}$',
    inputHint: 'Lihat nomor pelanggan pada tagihan atau kartu TV Anda',
    inputHintTyping: 'Lanjutkan — minimal 4 karakter',
    inputHintInvalid: 'Nomor pelanggan tidak valid — 4–20 karakter (huruf, angka, atau -)',
    skuCode: null,
    accent: '#D97706',
  },
  {
    name: 'insurance',
    title: 'Asuransi',
    subtitle: 'Bayar premi asuransi',
    icon: '<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path>',
    inputLabel: 'Nomor Polis Asuransi',
    inputType: 'text',
    inputMode: null,
    inputPrefix: null,
    inputPlaceholder: 'Contoh: POL-123456789',
    inputMinLength: 4,
    inputMaxLength: 25,
    // Alfanumerik + tanda hubung/garis bawah, kompatibel multi-perusahaan asuransi
    validationPattern: '^[A-Za-z0-9\\-\\_]{4,25}$',
    inputHint: 'Masukkan nomor polis sesuai kartu atau dokumen asuransi Anda',
    inputHintTyping: 'Lanjutkan — minimal 4 karakter',
    inputHintInvalid: 'Nomor polis tidak valid — 4–25 karakter (huruf, angka, - atau _)',
    skuCode: null,
    accent: '#276749',
  },
  {
    ...
    subtitle: 'Bayar tagihan kartu pascabayar',
    icon: '<rect x="5" y="2" width="14" height="20" rx="2" ry="2"></rect><line x1="12" y1="18" x2="12.01" y2="18"></line>',
    inputLabel: 'Nomor HP Pascabayar',
    inputType: 'tel',
    inputMode: 'numeric',
    inputPrefix: '+62',
    inputPlaceholder: '8xx xxxx xxxx',
    inputMinLength: 9,
    inputMaxLength: 13,
    // Validasi ditangani phoneStatus() — validationPattern tidak dipakai untuk isPhoneInput
    validationPattern: null,
    inputHint: 'Masukkan nomor HP kartu pascabayar tanpa angka 0 di depan',
    inputHintTyping: 'Lanjutkan mengetik nomor HP Anda…',
    inputHintInvalid: 'Nomor tidak dikenali — pastikan nomor HP Indonesia yang valid',
    skuCode: null,
    accent: '#E53E3E',
  },
];